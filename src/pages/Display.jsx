...
function Display({ profileData }) {
  ...
  return (
    <section
      className={`overflow-hidden mt-8 p-6 rounded-lg shadow-lg ${
        themeMode === "dark" ? "bg-[#1d2a4a]" : "bg-white"
      }`}
    >
        ...
        <div className="flex-1">
          <div className="flex flex-col md:flex-row justify-between items-start mb-6">
            <div>
              ...
              <div className="text-sm text-[hsl(219,64%,45%)]">
                @{profileData.login}
              </div>
            </div>
          ...
          <div className="text-[#7f8a9f] mb-6">
            {profileData.bio || "No bio available"}
          </div>
          <div
            className={`p-6 rounded-lg mb-6 shadow-md ${
              themeMode === "dark" ? "bg-[#131b2e]" : "bg-[#f6f8ff]"
            }`}
          >
